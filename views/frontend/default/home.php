                                        ...
                                        <div class="d-block">
                                            ...
                                            <?php else : ?>
                                                <?php if ($latest_course['discount_flag'] == 1) : ?>
                                                    <?php if ($latest_course['price_type'] == 'monthly') : ?>
                                                        <p class="price text-right d-inline-block float-end"><small><?php echo currency($latest_course['price']); ?>/Monthly</small><?php echo currency($latest_course['discounted_price']); ?>/Monthly</p>
                                                    <?php else : ?>
                                                ...
                                                <?php else : ?>
                                                    <?php if ($latest_course['price_type'] == 'monthly') : ?>
                                                        <p class="price text-right d-inline-block float-end"><?php echo currency($latest_course['price']); ?>/Monthly</p>
                                                    <?php else : ?>
