                    ...
                    <div class="course-price">
                        ...
                        <?php else : ?>
                            <?php if ($course['discount_flag'] == 1) : ?>
                                ...
                                <?php if ($course['price_type'] == 'monthly') : ?>
                                    <span class="current-price"><?php echo currency($course['discounted_price']); ?>/Monthly</span>
                                    <p class="original-price"><?php echo currency($course['price']); ?>/Monthly</p>
                                <?php else : ?>
                                    <span class="current-price"><?php echo currency($course['discounted_price']); ?></span>
                                    <p class="original-price"><?php echo currency($course['price']); ?></p>
                                <?php endif; ?>
                            <?php else : ?>
                                <?php if ($course['price_type'] == 'monthly') : ?>
                                    <p class="current-price"><?php echo currency($course['price']); ?>/Monthly</p>
                                <?php else : ?>
                                    <p class="current-price"><?php echo currency($course['price']); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
