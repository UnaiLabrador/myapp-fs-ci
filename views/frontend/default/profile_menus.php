<section class="page-header-area my-course-area">
  ...
  <div class="container">
    <ul class="print-hidden">
      ...
      <li class="<?php if($page_name == 'my_notifications') echo 'active'; ?>"><a href="<?php echo site_url('home/my_notifications'); ?>"> <i class="far fa-bell"></i> <?php echo site_phrase('my_notifications'); ?></a></li>
