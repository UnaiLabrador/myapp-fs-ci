                                ...
                                <?php else : ?>
                                    <?php if ($course['discount_flag'] == 1) : ?>
                                        <?php if ($course['price_type'] == 'monthly') : ?>
                                            <p class="price text-right d-inline-block float-end"><small><?php echo currency($course['price']); ?>/Month</small><?php echo currency($course['discounted_price']); ?>/Month</p>
                                        <?php else : ?>
                                    ...
                                    <?php else : ?>
                                        <?php if ($course['price_type'] == 'monthly') : ?>
                                            <p class="price text-right d-inline-block float-end"><?php echo currency($course['price']); ?>/Monthly</p>
                                        <?php else : ?>
