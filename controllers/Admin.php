...
class Admin extends CI_Controller
{
    ...
    public function basic_enrol(){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        $page_data['page_name'] = 'basic_enrol';
        $page_data['page_title'] = get_phrase('basic_enrollment');
        $this->load->view('backend/index', $page_data);

    }
    public function bundle_enrol(){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        $page_data['page_name'] = 'bundle_enrol';
        $page_data['page_title'] = get_phrase('basic_enrollment');
        $this->load->view('backend/index', $page_data);
    }
    public function course_progress(){
        ...
        $page_data['page_name'] = 'course_progress';
        $page_data['page_title'] = get_phrase('course_progress_management');
        $this->load->view('backend/index', $page_data);
    }
